...
def save_detailed_stats(dataset, summary_file="data/5_summary_gemini_flash.json"):
...
def main():
    input_file = "data/3_results_gemini_flash.json"
    output_file = "data/4_evaluation_gemini_flash.json"
