...
INPUT_FILE = f"data/3_results_template_{MODEL_KEY}.json"
OUTPUT_FILE = f"data/4_evaluation_template_{MODEL_KEY}.json"
SUMMARY_FILE = f"data/5_summary_template_{MODEL_KEY}.json"
